...
import com.arp.citysipspreadster.databinding.ActivityPrivacyPolicyBinding
...
class PrivacyPolicyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.webView.loadUrl("http://medicaiditpark.com/city_slip/api-firebase/spredster/web_view_privacy.php")
    }
}