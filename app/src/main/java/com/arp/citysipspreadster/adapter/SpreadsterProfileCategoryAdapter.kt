...
import com.arp.citysipspreadster.activites.SpreadsterProfileActivity
...
class SpreadsterProfileCategoryAdapter(var context: Context, private var users: List<ProfileCategory>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<SpreadsterProfileCategoryAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        val user: ProfileCategory = users[position]
        ...
        if (index == SpreadsterProfileActivity.catposNew.toInt()) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickListner.onCategoryItemClicked(position)
    ...
    fun updateList(searchList : List<ProfileCategory>) {
    ...
    interface OnItemClickListner {
        fun onCategoryItemClicked(postion: Int)
    }
