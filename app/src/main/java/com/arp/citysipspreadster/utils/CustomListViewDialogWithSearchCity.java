...
public class CustomListViewDialogWithSearchCity extends Dialog implements View.OnClickListener {
    ...
    CityListSearchAdapter adapter;
    List<Category> newParties;
    LinearLayout ll_error;
    private RecyclerView.LayoutManager mLayoutManager;

    public CustomListViewDialogWithSearchCity(Context context, int themeResId) {
        super(context, themeResId);
    }

    public CustomListViewDialogWithSearchCity(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }


    public CustomListViewDialogWithSearchCity(Activity a, CityListSearchAdapter adapter, List<Category> newParties) {
        super(a);
        this.activity = a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recycler_view_with_search_city);
