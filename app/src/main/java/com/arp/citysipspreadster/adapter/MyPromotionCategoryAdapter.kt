...
class MyPromotionCategoryAdapter(var context: Context, private var users: List<Category>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<MyPromotionCategoryAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        ...
        if (index == MyPromotionActivity.catpos.toInt()) {
