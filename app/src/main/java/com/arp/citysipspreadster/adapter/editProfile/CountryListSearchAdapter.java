...
public class CountryListSearchAdapter extends RecyclerView.Adapter<CountryListSearchAdapter.FruitViewHolder> {

    List<Country> mDataset;
    RecyclerViewItemClickListener recyclerViewItemClickListener;

    public CountryListSearchAdapter(List<Country> myDataset, RecyclerViewItemClickListener listener) {
        mDataset = myDataset;
    ...
    public void updatelist(List<Country> productMasters) {
