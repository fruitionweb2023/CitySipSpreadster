...
class MyWalletHistroyListAdapter(var context: Context, private var users: List<Histroy>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<MyWalletHistroyListAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        val user: Histroy = users[position]
        ...
        holder.binding.txtRequest.text = user.notes
        ...
        holder.itemView.setOnClickListener {
            ...
            onItemClickListner.onHistroyListItemClicked(position)
        }
    }
    ...
    fun updateList(searchList : List<Histroy>) {
    ...
    interface OnItemClickListner {
        fun onHistroyListItemClicked(postion: Int)
    }
