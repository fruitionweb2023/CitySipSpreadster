...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.clr_EA2A31));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.clr_EA2A31));
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.clr_EA2A31));
