...
public class StateListAdapter extends ArrayAdapter<Category> {

    LayoutInflater layoutInflater;
    ArrayList<Category> cuisines;

    public StateListAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<Category> cuisines) {
