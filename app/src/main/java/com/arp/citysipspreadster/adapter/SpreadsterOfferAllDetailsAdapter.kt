...
class SpreadsterOfferAllDetailsAdapter(var context: Context, private var users: List<ProfileOffer>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<SpreadsterOfferAllDetailsAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        val user: ProfileOffer = users[position]
    ...
    fun updateList(searchList : List<ProfileOffer>) {
