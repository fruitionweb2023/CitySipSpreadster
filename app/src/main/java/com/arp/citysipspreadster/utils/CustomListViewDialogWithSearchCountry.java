...
public class CustomListViewDialogWithSearchCountry extends Dialog implements View.OnClickListener {
    ...
    CountryListSearchAdapter adapter;
    List<Country> newParties;
    LinearLayout ll_error;
    private RecyclerView.LayoutManager mLayoutManager;

    public CustomListViewDialogWithSearchCountry(Context context, int themeResId) {
        super(context, themeResId);
    }

    public CustomListViewDialogWithSearchCountry(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }


    public CustomListViewDialogWithSearchCountry(Activity a, CountryListSearchAdapter adapter, List<Country> newParties) {
        super(a);
        this.activity = a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recycler_view_with_search_country);
