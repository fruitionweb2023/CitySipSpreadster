...
public class CustomListViewDialogWithSearch extends Dialog implements View.OnClickListener {
    ...
    CategoryListSearchAdapter adapter;
    List<OnboardCategory> newParties;
    ...
    public CustomListViewDialogWithSearch(Activity a, CategoryListSearchAdapter adapter, List<OnboardCategory> newParties) {
        super(a);
        this.activity = a;
    ...
    public void filterCategory(String text) {
        ...
        ArrayList<OnboardCategory> temp = new ArrayList<>();

        if (newParties != null) {
            for (OnboardCategory d : newParties) {
