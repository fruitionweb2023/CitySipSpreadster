...
class CustomerSupportAdapter(var context: Context, private var users: List<Help>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<CustomerSupportAdapter.UsersViewHolder?>() {
