...
public class CountryAdapter extends ArrayAdapter<Country> {
    ...
    public CountryAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<Country> cuisines) {
    ...
    public void updateList(ArrayList<Country> country) {
        this.cuisines = country;
