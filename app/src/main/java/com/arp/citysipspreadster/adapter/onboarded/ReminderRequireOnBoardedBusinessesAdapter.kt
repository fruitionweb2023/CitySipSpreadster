...
import com.arp.citysipspreadster.databinding.RawSelectAllCheckboxOnboardBusinessesBinding
...
class ReminderRequireOnBoardedBusinessesAdapter(var context: Context, private var users: List<OnboardedBusiness1>, private var OncheckBoxClickListner: OnCheckBoxClickListner,private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<ReminderRequireOnBoardedBusinessesAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
      ...
      /*  bottomSheetDialog = BottomSheetDialog(context)
        ...
        val binding3: RawSelectAllCheckboxOnboardBusinessesBinding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.raw_select_all_checkbox_onboard_businesses,
            null,
            false
        )
        bottomSheetDialog!!.setContentView(binding3.root)
*/
        ...
        holder.itemView.setOnClickListener {
            onItemClickListner.onRequiredReminderBoardedBusinesses(position)
        }

        holder.binding.cbOnBusiness.setOnClickListener {
            OncheckBoxClickListner.onCheckBoxClicked(position,holder.binding.cbOnBusiness,count)
        }
    ...
    interface OnItemClickListner {
        fun onRequiredReminderBoardedBusinesses(postion: Int)
    }

    interface OnCheckBoxClickListner {
        fun onCheckBoxClicked(postion: Int, check : CheckBox,count : Int)
    }
