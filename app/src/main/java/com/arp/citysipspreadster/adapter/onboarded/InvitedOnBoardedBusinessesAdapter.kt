...
class InvitedOnBoardedBusinessesAdapter(var context: Context, private var users: List<OnboardedBusiness1>) :
    RecyclerView.Adapter<InvitedOnBoardedBusinessesAdapter.UsersViewHolder?>() {
    ...
    interface OnItemLongClickListner {
        fun onInvitedBoardedBusinesses(postion: Int)
    }
