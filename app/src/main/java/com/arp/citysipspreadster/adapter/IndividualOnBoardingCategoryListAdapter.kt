...
import com.arp.citysipspreadster.activites.IndividualOnBoarding
...
class IndividualOnBoardingCategoryListAdapter(var context: Context, private var users: List<OnboardCategory>, private var onItemClickListner: OnItemClickListner) :
    RecyclerView.Adapter<IndividualOnBoardingCategoryListAdapter.UsersViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        ...
        if (index == IndividualOnBoarding.catpos.toInt()) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickListner.onindividualCategoryItemClicked(position)
    ...
    interface OnItemClickListner {
        fun onindividualCategoryItemClicked(postion: Int)
    }
